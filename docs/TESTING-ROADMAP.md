...
*corpora* (isemail/MIME torture), Postfix/Exim calibration of the receiver suite, and a deeper
IMAP-side scripted-conformance pass (imaptest's `test=` mode + longer soak) — plus opinionated
cuts kept naive on purpose (a single account; catch-all for
