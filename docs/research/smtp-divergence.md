...
| `<CR>.<CR>` (`0d 2e 0d`) | Cisco Secure Email Gateway (default "Clean" converts bare CR/LF → CRLF) | — |
| `<CR><CR><LF>.<CR><CR><LF>` | SEC Consult variant | — |
...
Defines a 13-payload end-of-data test corpus (Table 1, A1–A13) of `\n`/`\r`/`\r\n`
...
14 attacks (A1–A14) across sending/receiving/forwarding/rendering, exploiting four identity
