...
**The conformance suite (0001 to 0008):** the spec baseline, the runner, and the surfaces the
suite covers:
...
**The mail server (0009 to 0020):** the product decisions: storage, delivery, auth, and operations:
