...
Tester) to be the only genuinely server-agnostic scripted protocol harness in the email space:

- Apache-2.0, latest 3.9.0 released 2025-09-25, 23 versions on Maven Central — maintained.
...
3. **The mechanics are the easy part.** A script runner over a socket is genuinely not much code.
