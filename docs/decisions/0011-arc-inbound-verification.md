...
ADR 0010 made cutie-mail enforce inbound DMARC by filing failures to Junk. That is correct
...
- **ARC sealing (the outbound/forwarding half).** cutie-mail is a final-delivery server; it
