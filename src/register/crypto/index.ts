...
export const EXTRACTED_SECTIONS: readonly string[] = ['3.4.1', '3.4.2', '3.4.3', '3.4.4', '3.5'];

export const CRYPTO_REQUIREMENTS = [...DKIM_CANON, ...DKIM_SIGNATURE] as const satisfies readonly RequirementDef[];
