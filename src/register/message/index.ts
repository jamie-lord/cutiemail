...
import { DSN } from './sections/dsn.ts';
 ...
 */
export const EXTRACTED_SECTIONS: readonly string[] = ['2', '2.1', '2.1.1', '2.2', '2.3.2', '2.3.3', '2.3.6', '3.3', '3.4.1', '3.6', '4', '5', '5.1', '5.1.1', '5.2', '6', '6.2', '6.4'];
